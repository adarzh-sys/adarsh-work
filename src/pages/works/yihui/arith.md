...
arith began as a CLI image compressor / decompressor that my friend Toby and I built in C for a [college class](https://github.com/adarsh/cs40). I subsequently ported the C code over to JavaScript so it could run on the web.

Feel free to play around with your own images [here](https://arith.vercel.app), or view the source code [here](https://github.com/adarsh/arith-js).
